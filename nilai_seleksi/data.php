<?php include_once('../_header.php'); ?>
    ...
    <div class="box">
       <h1>Nilai Seleksi Pelamar</h1>
       <h4>
           <small>Nilai Seleksi Tes Tulis dan Wawancara</small>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                $sql_nilaiseleksi = mysqli_query($con, $query) or die (mysqli_error($con));
                if(mysqli_num_rows($sql_nilaiseleksi) > 0) {
                    while($data = mysqli_fetch_array($sql_nilaiseleksi)) { ?>
                        <tr>
                            <td><?=$no++?></td>
                            <td><?=$data['nama']?></td>
                            <td><?=$data['Skor_Tes_Tulis']?></td>
                            <td><?=$data['Skor_Wawancara']?></td>
